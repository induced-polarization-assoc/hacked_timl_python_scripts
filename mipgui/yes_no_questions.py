...
def save_yes_no():
    ...
    if usr_says is True:
        ...
        if verify is 'ok':
            ...
            output_save_to = mipgui.file_dialogs.set_save_path()
    else:
        cancel_me = tkinter.messagebox.askyesno('QUIT?', 'Would you like to exit the application now?')
        if cancel_me:
            print("Goodbye")
            sys.exit()
        else:
            print("Ok, restarting the question dialogue...")
            save_yes_no()
